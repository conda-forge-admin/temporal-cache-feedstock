About temporal-cache-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/temporal-cache-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/temporal-cache-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add temporal-cache
# for installing globally
pixi global install temporal-cache
```
...
It is possible to list all of the versions of `temporal-cache` available on your platform:
...
```
pixi search temporal-cache --channel conda-forge
```
